const entries = [
  ...
  },
  {
    index: 3,
    author: 'Kalixer & ChatGPT',
    title: '¿1 piso o 2 pisos? Cómo elegir',
    image: 'https://images.pexels.com/photos/186077/pexels-photo-186077.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    description: 'Tomar una decisión no debería ser difícil. Con esta guía podrás ver las ventajas de cada una y ver cuál se ajusta a tu estilo de vida'
  },
  {
    index: 4,
    author: 'Kalixer & ChatGPT',
    title: 'El respaldo de un ingeniero civil hace la diferencia',
    image: 'https://images.pexels.com/photos/220301/pexels-photo-220301.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    description: 'Por qué tu hogar merece ser construido por un Ingeniero Civil.'
  },
  {
    index: 5,
    author: 'Kalixer & ChatGPT',
    title: 'Diseños predefinidos o Diseño en conjunto',
    image: 'https://images.pexels.com/photos/326502/pexels-photo-326502.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    description: 'Puedes elegir entre lo que ya probamos que funciona o podemos aventurarnos en darle tu sello personal.'
  },
]
